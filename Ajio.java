...
public class Ajio {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.edge.driver", "./drivers./msedgedrive_oldr.exe");
		...
		WebElement bags = driver.findElementByXPath("(//span[text()='Bags in '])[1]");
		Actions builderbags = new Actions(driver);
		
		builderbags.moveToElement(bags).click().build().perform();
		Thread.sleep(1000);
	    ...
	    //Click on the product "Ferrari LS Shoulder Bag" 
		...
		driver.findElementByXPath("//input[@class='edd-pincode-modal-text']").sendKeys("600042");
